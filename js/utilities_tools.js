...
function updateSolves() {
    ...
    document.querySelector("#crackps").innerText = "CPT: " + ((((player.bcracks * (0.025 + (0.005 * (player.cFormula - 1)))) / (1 + (1 + player.bcracks) / 1 + player.bcracks))) * player.cMultiplier).toFixed(5);
